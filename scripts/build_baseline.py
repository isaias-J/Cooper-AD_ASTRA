...
def main():
 ...
 encoder=Encoder(a.model,device=a.device,use_fp16=not a.no_fp16,cache_dir=a.cache_dir); extraction_cache=ExtractionCache(a.cache_dir); chunks=[]; failures=[]; cache_hits=0
